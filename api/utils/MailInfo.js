module.exports = {
    ...
    WELCOME_PASS(name, P) {
        return ["Senha de acesso para plataforma Controle CAS",
        '<h2 style="text-align: center">Bem vindo '+name+' !</h2>'+
        '<p>&emsp;</p>'+
        '<h4 style="text-align: center">Utilize a senha abaixo para autenticar-se na plataforma CAS:</h4>'+
        ...
        '<p style="text-align: center; font-weight: 600">Controle CAS @ CAS Automações e Sistemas</p>']
    },

    WELCOME_CODE(name, code) {
        return ["Código de acesso para plataforma Controle CAS",
    '<h2 style="text-align: center">Bem vindo '+name+' !</h2>'+
    '<p>&nbsp;</p>'+
    '<p style="text-align: center">Você foi cadastrado na plataforma CAS como instalador.</p>'+
    '<h4 style="text-align: center">Utilize o código abaixo para autenticar-se na plataforma CAS de instaladores (Config CAS):</h4>'+
    '<table style="text-align: center;" width="100%">'+
    '<tr>'+
    '<td>&emsp;</td>'+
    ...
    '<p style="text-align: center">Caso perca seu código ou necessite alterá-lo, basta enviar um e-mail para <a href="mailto:suporte@casas.ind.br?subject=[Instalador] Código de instalação" title="">suporte@casas.ind.br</a> (ou responder este e-mail).</p>'+
    '<p>&nbsp;</p><p>&nbsp;</p>'+
    '<p style="text-align: center; font-weight: 600">Controle CAS @ CAS Automações e Sistemas</p>']
    },

    RENEW_PASS(name, P) {
        return ["Recuperação de senha para plataforma Controle CAS",
